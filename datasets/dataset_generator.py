...
ds = load_dataset("Harvard-Edge/Wake-Vision", split="train_quality", streaming=True)
...
os.makedirs("wv_train_cache", exist_ok=True)
shard_id = 0
...
for i, ex in enumerate(ds):
    ...
    if len(buf_x) == SHARD:
        torch.save(
            ...
            f"wv_train_cache/shard-{shard_id:05d}.pt"
        )
        shard_id += 1
